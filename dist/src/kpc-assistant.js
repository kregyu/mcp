...
export class KPCAssistant {
     ...
     * 验证使用方式
     */
    validateUsage(componentName, props) {
        const component = this.dataLoader.getComponent(componentName);
        if (!component) {
     ...
     * 获取示例
     */
    getExamples(componentName, scenario) {
        const component = this.dataLoader.getComponent(componentName);
        if (!component) {
...
//# sourceMappingURL=kpc-assistant.js.map